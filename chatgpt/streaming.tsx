...
const postDataStream = async (url:string, model:string, max_tokens: number, history: any, message: any, temperature: number = 0.7, systemPrompt:string = "You are a helpful assistance.", callback: any) => {
  console.log("postDataStream:", url);
  let messages = [
    {
      role: "system",
...
const postDataStream = async (url: string, model: string, max_tokens: number, message: string, callback: any, temperature: number = 0.7, systemPrompt: string = "You are a helpful assistance.") => {
  console.log("postDataStream:", url);
  let messages = [
    {
      role: "system",
